...
const Hero = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div className="absolute bottom-20 left-10 w-48 h-48 bg-sakura-200/30 rounded-full blur-3xl animate-float" style={{
      animationDelay: '1s'
    }} />
    ...
    <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto py-[16px]">
      ...
      <div className="mb-8 animate-fade-in">
        <p className="text-lg sm:text-xl text-muted-foreground font-japanese mb-2">
          こんにちは
        </p>
      ...
      {/* Main Heading */}
      <h1 className="text-4xl sm:text-6xl lg:text-8xl font-bold mb-6 animate-fade-in" style={{
        animationDelay: '0.2s'
      }}>
        I'm{' '}
      ...
      <div className="mb-8 animate-fade-in" style={{
        ...
        <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          ...
          open-source contributions, and a passion for clean, accessible design.
        </p>
      </div>
      ...
      <div className="mb-12 animate-fade-in" style={{
        ...
        <p className="text-sm text-muted-foreground font-japanese mt-2">
          (sōzō - creation)
        </p>
      </div>
      ...
      <div className="mb-12 animate-fade-in" style={{
        ...
        <p className="text-muted-foreground mt-2 font-japanese text-xs font-normal text-center">スクロール</p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in" style={{
        ...
        <Button onClick={scrollToProjects} size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground font-medium px-8 py-3 rounded-lg transition-all duration-300 hover:scale-105">
          View My Work
        </Button>
