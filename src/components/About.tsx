    ...
    <div className="max-w-6xl mx-auto relative z-10">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Developer, creator, and lifelong learner passionate about building meaningful digital experiences.
        </p>
      </div>
        ...
        <div className="space-y-6 animate-fade-in">
          <Card className="bg-card/50 backdrop-blur-sm border-border/50">
            <CardContent className="p-8">
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                My passion for development started with curiosity about how things work behind the scenes.
                I specialize in modern web technologies, creating applications that are both functional and beautiful.
              </p>
              <p className="text-foreground/80 leading-relaxed">
                I believe in writing clean, maintainable code and contributing to open-source projects
          ...
          <Card className="bg-card/50 backdrop-blur-sm border-border/50">
            <CardContent className="p-8">
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                Inspired by Japanese design principles of simplicity and attention to detail,
                I focus on creating experiences that are intuitive and meaningful.
              </p>
